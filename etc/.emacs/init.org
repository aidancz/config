...
#+begin_src emacs-lisp
(setq load-path (cons (concat (getenv "XDG_CONFIG_HOME") "/emacs/src/org-mode/lisp") load-path))
...
(setq load-path (cons (concat (getenv "XDG_CONFIG_HOME") "/emacs/src/eaf") load-path))
(require 'eaf)
(require 'eaf-demo)
