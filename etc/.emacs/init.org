...
(define-key evil-normal-state-map (kbd "C-j") (lambda () (interactive) (evil-ex-execute "put _")))
(define-key evil-normal-state-map (kbd "C-k") (lambda () (interactive) (evil-ex-execute "put! _")))
