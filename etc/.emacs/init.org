...
(when (and (not (null title)) (not (string= title name)))
(let (
...
(define-key evil-normal-state-map (kbd "C-k") 'evil-scroll-line-to-top)
(define-key evil-normal-state-map (kbd "C-l") 'evil-scroll-line-to-center)
(define-key evil-normal-state-map (kbd "C-j") 'evil-scroll-line-to-bottom)
...
(define-key evil-insert-state-map (kbd "C-k") 'evil-scroll-line-to-top)
(define-key evil-insert-state-map (kbd "C-l") 'evil-scroll-line-to-center)
(define-key evil-insert-state-map (kbd "C-j") 'evil-scroll-line-to-bottom)
