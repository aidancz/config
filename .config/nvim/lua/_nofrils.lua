...
vim.api.nvim_set_hl(0, "CursorLine",     {link = "nofrils_underline"})
vim.api.nvim_set_hl(0, "CursorLineFold", {link = "nofrils_underline"})
vim.api.nvim_set_hl(0, "CursorLineNr",   {link = "nofrils_underline"})
vim.api.nvim_set_hl(0, "CursorLineSign", {link = "nofrils_underline"})
