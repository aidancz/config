...
vim.api.nvim_set_hl(0, "DiagnosticInfo",  {link = "nofrils-blue"})
vim.api.nvim_set_hl(0, "DiagnosticHint",  {link = "nofrils-blue"})
...
vim.api.nvim_set_hl(0, "DiagnosticVirtualTextInfo",  {link = "nofrils-blue"})
vim.api.nvim_set_hl(0, "DiagnosticVirtualTextHint",  {link = "nofrils-blue"})
...
vim.api.nvim_set_hl(0, "DiagnosticUnderlineInfo",  {link = "nofrils-blue"})
vim.api.nvim_set_hl(0, "DiagnosticUnderlineHint",  {link = "nofrils-blue"})
...
vim.api.nvim_set_hl(0, "DiagnosticFloatingInfo",  {link = "nofrils-blue"})
vim.api.nvim_set_hl(0, "DiagnosticFloatingHint",  {link = "nofrils-blue"})
...
vim.api.nvim_set_hl(0, "DiagnosticSignInfo",  {link = "nofrils-blue"})
vim.api.nvim_set_hl(0, "DiagnosticSignHint",  {link = "nofrils-blue"})
vim.api.nvim_set_hl(0, "DiagnosticSignOk",    {link = "nofrils-green"})

vim.api.nvim_set_hl(0, "DiagnosticDeprecated",  {link = "nofrils-red"})
vim.api.nvim_set_hl(0, "DiagnosticUnnecessary", {link = "nofrils-red"})
