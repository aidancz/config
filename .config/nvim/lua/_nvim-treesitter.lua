...
vim.api.nvim_set_hl(0, "@markup.heading.2", {link = "nofrils_green"})
vim.api.nvim_set_hl(0, "@markup.heading.3", {link = "nofrils_yellow"})
vim.api.nvim_set_hl(0, "@markup.heading.4", {link = "nofrils_blue"})
vim.api.nvim_set_hl(0, "@markup.heading.5", {link = "nofrils_magenta"})
vim.api.nvim_set_hl(0, "@markup.heading.6", {link = "nofrils_cyan"})
